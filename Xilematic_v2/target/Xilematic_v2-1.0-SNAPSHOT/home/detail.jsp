        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="movie-actions">
                    ...
                    <button class="btn-book" onclick="window.location.href = '${pageContext.request.contextPath}/SelectCalendar?id=${movie.id}&movieName=${movie.movieName}'">
                ...
                <div class="movie-details">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <span>${movie.director != null ? movie.director : 'Chưa cập nhật'}</span></p>
                        </div>
                        <div class="col-md-6">
                            <p><strong><i class="ph-bold ph-users"></i> Diễn viên:</strong> 
                            <span>${movie.actor != null ? movie.actor : 'Chưa cập nhật'}</span></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="comment-form">
                <c:choose>
                    <c:when test="${not empty sessionScope.userInfor}">
                        <textarea class="comment-input" id="comment-input" placeholder="Chia sẻ cảm nhận của bạn về phim..."></textarea>
                    ...
                    <c:otherwise>
                        <div class="login-prompt">
                            <p>Vui lòng <a href="${pageContext.request.contextPath}/login.jsp" class="login-link">đăng nhập</a> để bình luận</p>
                        </div>
                    </c:otherwise>
                </c:choose>
            </div>
    ...
    <div class="trailer-modal" id="trailerModal">
        <div class="modal-content">
            ...
            <div class="trailer-iframe">
                <iframe id="trailerIframe" src="${movie.trailer}" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
        </div>
    </div>
