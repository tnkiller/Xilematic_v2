    ...
    public class MovieDAO implements IMovieDAO {
        ...
        private final String SELECT_MOVIES_BY_GENRE_NAME = """
        	    SELECT p.*
        	    FROM Phim_TheLoai pt
        	    INNER JOIN Phim p ON pt.ma_phim = p.ma_phim
        	    INNER JOIN TheLoai t ON pt.ma_the_loai = t.ma_the_loai
        	    WHERE t.ten_the_loai = ? AND (p.is_active IS NULL OR p.is_active = 1)
        	""";
        @Override
        ...
        public List<Movie> getMoviesByGenreName(String genreName) throws SQLException {
            ...
            try (Connection con = DBConnection.getConnection()) {
                PreparedStatement ps = con.prepareStatement(SELECT_MOVIES_BY_GENRE_NAME);
        ...
        public static void main(String[] args) throws SQLException {
        	 MovieDAO dao = new MovieDAO();
        	    List<Movie> actionMovies = dao.getMoviesByGenreName("Hành động");
