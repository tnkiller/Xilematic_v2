...
public class AuthFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        boolean isgooglePage = path.startsWith(contextPath + "/ggcallback");
        ...
        System.out.println("  - isisgooglePage: " + isgooglePage);
        ...
        if (loggedIn || isHomePage || isDetailPage || isSelectCalendarPage || isLoginPage || isRegisterPage || isAuthenticateAction || isResource || isintermediatePage || isgooglePage) {
