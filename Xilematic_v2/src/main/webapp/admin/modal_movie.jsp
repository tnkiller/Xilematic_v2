...
<html>
    ...
    <body>
        <div class="modal fade" id="modal_movie" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <!--bat dau form-->
                        <form action="<%=request.getContextPath()%>/intermediate.jsp" method="POST" id="myMovieForm">
                    ...
                    <div class="modal-footer">
                        <button type="submit" form="myMovieForm" class="btn btn-primary"><%= request.getParameter("action")%></button>
                    </div>
                </div>
            </div>
        </div>
